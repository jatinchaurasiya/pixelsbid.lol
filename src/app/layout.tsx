...
export const metadata: Metadata = {
  title: "PixelsBid.lol — Buy pixels. Outbid the rest. Get noticed.",
  ...
  openGraph: {
    title: "PixelsBid.lol — The 1,000,000 Pixel Billboard",
      ...
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased bg-[#fcfcfc]`}>
        ...
        <footer className="border-t border-zinc-200 bg-white mt-16">
          <div className="mx-auto max-w-[1400px] px-4 py-12 grid sm:grid-cols-4 gap-8 text-sm">
            <div>
              <Link href="/" className="flex items-center gap-2.5">
                <img src="/logo.png" alt="PixelsBid" className="w-7 h-7 rounded-lg object-contain" />
                <span className="font-black text-lg tracking-tight">pixelsbid<span className="text-[#ff3b30]">.lol</span></span>
              </Link>
          ...
          <div className="border-t border-zinc-100 text-center text-xs text-zinc-500 py-4">
            © 2026 PixelsBid.lol — All pixels rented are active 30-day exclusive placements.
          </div>
        </footer>
      </body>
    </html>
